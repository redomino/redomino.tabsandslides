...
def setup_product():
    ...
    import redomino.tabsandslides
    zcml.load_config('configure.zcml', redomino.tabsandslides)
    ...
    ztc.installPackage('redomino.tabsandslides')
...
setup_product()
ptc.setupPloneSite(products=['redomino.tabsandslides'],
                   extension_profiles=['redomino.tabsandslides:default']) 
